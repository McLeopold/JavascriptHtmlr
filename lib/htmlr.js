;(function (exports) {
  ...
  var HtmlrString = (function () {
    function Class() {
      this.value = Array.prototype.slice.call(arguments).join('');
  ...
  HtmlrString.prototype.supplant = function (obj) {
      return this.replace(/{([^{}]*)}/g,
          function (match, param) {
              if (match === '{}') {
                ...
                return typeof sub === 'string' || typeof sub === 'number' ? sub : match;
              }
          }
      );
  };
  ...
  // Create a new constructor that inherits from this
  // equivilant to HtmlrClass.prototype.__proto__ = this.prototype;
  Htmlr.copy = function (constructor) {
    var HtmlrClass = constructor || function () {};
    HtmlrClass.prototype = new this();
    ...
    HtmlrClass.chainer = Htmlr.chainer;
  ...
  var span = Htmlr.create('span');
  span.class.prototype.empty_element = false;
